...
public class MultiObjectiveProblem {
	...
	public static final Knapsack OPTIMAL_KNAPSACK_0 =
			ProblemUtil.getOptimalKnapsack( optimalSolution_0, ITEMS, MAX_CAPACITY_0 );
	public static final Knapsack OPTIMAL_KNAPSACK_1 =
			ProblemUtil.getOptimalKnapsack( optimalSolution_1, ITEMS, MAX_CAPACITY_1 );
